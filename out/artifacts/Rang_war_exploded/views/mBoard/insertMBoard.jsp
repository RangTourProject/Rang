        ...
        <div class="ml-auto">
            <div class="form-area">
                <form role="form" action="${pageContext.request.contextPath}/insert.mb" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" type="textarea" id="mbcontent" name="mbcontent" placeholder="글 내용" maxlength="1000" rows="7"></textarea>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#btnDiscard2').on('click', function () {
                ...
                $('#btnChangePicture2').attr('value', 'Change');
                $('#btnDiscard2').addClass('d-none');
                $('#imgProfile2').attr('src', $imgSrc);
                $('#profilePicture2').val('');
                // }
            });
        });
        ...
        $(function () {
            ...
            $('#btnDiscard3').on('click', function () {
                ...
                $('#btnChangePicture3').attr('value', 'Change');
                $('#btnDiscard3').addClass('d-none');
                $('#imgProfile3').attr('src', $imgSrc);
                $('#profilePicture3').val('');
                // }
            });
        });
        ...
        $(function () {
            ...
            $('#btnDiscard4').on('click', function () {
                ...
                $('#btnChangePicture4').attr('value', 'Change');
                $('#btnDiscard4').addClass('d-none');
                $('#imgProfile4').attr('src', $imgSrc);
                $('#profilePicture4').val('');
                // }
            });
        });
